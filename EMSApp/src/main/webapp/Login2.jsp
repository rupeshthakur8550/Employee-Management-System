...
<body>
<body>
	<form action="./Login2" method="post" name="myform" onsubmit="return validate()">
		<div class="header">
		...
		<div class="Login">
    		<div class="box">
            	<fieldset>
            		<legend>Login</legend>
               			<input type="text" placeholder="Enter Employee ID" id="usr" name="usr">
                		<input type="password" placeholder="Enter Password" id="pwd" name="pwd">
                		<input type="submit" value="Login"/> <input type="reset" value="clear">
                		<center><a href="Reset2.jsp">Reset password</a></center>
