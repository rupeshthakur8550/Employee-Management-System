...
<body>
	<div class="Register">
		<div class="box">
			<form action="./EDelandUpdate" method="post" name="myform" onsubmit="return validate()">
			<fieldset>
				<legend>Employee Password Reset</legend>
					<br>
					<br> 
					<label for="usr">Employee ID:</label><input type="text" id="usr" name="usr" />
					...
					<br>
					<center>
						<a href="Login2.jsp">Return to Admin Login</a>
					</center>
			</fieldset>
			</form>
		</div>
